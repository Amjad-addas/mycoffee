...
const SignUp = () => {
  ...
  return (
    ...
    <Typography className={classes.productsTitle} variant='h1'> Sign  Up</Typography>
    </Stack>
    ...
    <Check title="I agree to the terms of use and privacy policy"/>
    <LinkButton content ="Sign Up" />
    </Box>
  )
}
